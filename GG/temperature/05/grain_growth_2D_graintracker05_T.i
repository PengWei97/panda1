...
[Mesh]
  ...
  ymax = 4000 # maximum y-coordinate of the mesh
...
[Materials]
  [./CuGrGr]
    ...
    wGB = 3 # Width of the diffuse GB μm
...
[Executioner]
  ...
  [./TimeStepper]
    ...
    dt = 0.0002 # Initial time step.  In this simulation it changes.
...
[Outputs]
  file_base = outputs/grain_growth_2D_graintracker_04
  [./exodus]
