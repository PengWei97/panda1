...
[Mesh]
  ...
  nx = 124 # Number of elements in the x-direction
  ny = 31 # Number of elements in the y-direction
  xmin = 0    # minimum x-coordinate of the mesh
  xmax = 12400 # maximum x-coordinate of the mesh
  ymin = 0    # minimum y-coordinate of the mesh
  ymax = 3100 # maximum y-coordinate of the mesh
  elem_type = QUAD4  # Type of elements used in the mesh
  uniform_refine = 2 # Initial uniform refinement of the mesh

  parallel_type = distributed # Periodic BCs, the solution is to use "nemesis" output.
[]
...
[UserObjects]
  [./voronoi]
    ...
    grain_num = 2000 # Number of grains
    rand_seed = 2400
