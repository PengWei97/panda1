...
template <bool is_ad>
class GBEvolutionGGBaseTempl : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  GBEvolutionGGBaseTempl(const InputParameters & parameters);
...
typedef GBEvolutionGGBaseTempl<false> GBEvolutionGGBase;
typedef GBEvolutionGGBaseTempl<true> ADGBEvolutionGGBase;
