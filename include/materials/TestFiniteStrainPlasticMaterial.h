...
/**
 * TestFiniteStrainPlasticMaterial implements rate-independent associative J2 plasticity
 ...
 */
class TestFiniteStrainPlasticMaterial : public ComputeStressBase
{
public:
  static InputParameters validParams();

  TestFiniteStrainPlasticMaterial(const InputParameters & parameters);
