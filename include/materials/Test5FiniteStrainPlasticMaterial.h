...
/**
 * Test5FiniteStrainPlasticMaterial implements rate-independent associative J2 plasticity
 ...
 */
class Test5FiniteStrainPlasticMaterial : public ComputeStressBase
{
public:
  static InputParameters validParams();

  Test5FiniteStrainPlasticMaterial(const InputParameters & parameters);
