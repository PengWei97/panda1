...
/**
 * Test3FiniteStrainPlasticMaterial implements rate-independent associative J2 plasticity
 ...
 */
class Test3FiniteStrainPlasticMaterial : public ComputeStressBase
{
public:
  static InputParameters validParams();

  Test3FiniteStrainPlasticMaterial(const InputParameters & parameters);
