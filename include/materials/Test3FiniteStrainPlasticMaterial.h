...
protected:
   ...
   */
  virtual Real dyieldFunction_dinternal(const Real equivalent_plastic_strain, const Real hf );
   ...
   */
  Real getYieldStress(const Real equivalent_plastic_strain, const Real hf);
