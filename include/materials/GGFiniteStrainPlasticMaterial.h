...
/**
 * GGFiniteStrainPlasticMaterial implements rate-independent associative J2 plasticity
 ...
 */
class GGFiniteStrainPlasticMaterial : public ComputeStressBase
{
public:
  static InputParameters validParams();

  GGFiniteStrainPlasticMaterial(const InputParameters & parameters);
