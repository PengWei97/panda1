...
/**
 * GGComputeMultiPlasticityStress performs the return-map
 ...
 */
class GGComputeMultiPlasticityStress : public ComputeStressBase, public MultiPlasticityDebugger
{
public:
  static InputParameters validParams();

  GGComputeMultiPlasticityStress(const InputParameters & parameters);
...
protected:
  ...
  // MaterialProperty<RankTwoTensor> & _delta_plastic_strain;
