...
[UserObjects]
  [./str]
    ...
    value_0 = 4e5
    value_residual = 6.5e5
    rate = 15
    # sigma_y_cr = 6.5e5;
    # sigma_y_0 = 4E5;
    # R = 15;
    # varepslion_p = linspace(0,0.5,100)
    # sigma_y = sigma_y_cr+(sigma_y_0-sigma_y_cr).*exp(-R.*varepslion_p)
    # plot(varepslion_p,sigma_y)
  [../]
  [./j2]
...
[Outputs]
  file_base = ./j2_ExponentialHardening/j2_Exponential_out
  exodus = true
  [./csv]
    type = CSV
  [../]
