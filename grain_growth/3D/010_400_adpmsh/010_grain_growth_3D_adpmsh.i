...
[Mesh]
  ...
  xmax = 70 # maximum x-coordinate of the mesh
  ymin = 0    # minimum y-coordinate of the mesh
  ymax = 70 # maximum y-coordinate of the mesh
  zmin = 0
  zmax = 70
...
[GlobalParams]
  ...
  op_num = 28 # Number of order parameters used
...
[UserObjects]
  [./voronoi]
    ...
    grain_num = 400 # Number of grains
    rand_seed = 200
...
#     end_step = 5 # 在计算步为第五步的时候停止
  ...
  [./exodus2]
    ...
    end_time = 10000
#     start_step = 6
#     end_step = 10 # 在计算步为第五步的时候停止
#     sync_times = '0.45 0.525 0.6'
#     sync_only = true
  [../]
  [./exodus3]
    file_base = 3D_200_10000-15000
    type = Exodus
    interval = 1
    # append_date = true # 添加输出时间
    start_time = 10000
