...
# my_yield_0 = 700 # MPa
my_xmax = 16.0e1#10.0e1 # 3.0e3
my_ymax = 16.0e1 #10.0e1 # 1.0e3

my_nx = 50 #200 # 50
my_ny = 50 #50 # 20

my_xpoint = 8.0e1 # 5.0e1 # 3.0e3
my_ypoint = 8.0e1 # 5.0e1 # 1.0e3
my_radius = 7.14e1 # 6.2 miu m
