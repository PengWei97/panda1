...
# my_yield_0 = 700 # MPa
my_xmax = 20.0e1#10.0e1 # 3.0e3
my_ymax = 20.0e1 #10.0e1 # 1.0e3

my_nx = 50 #200 # 50
my_ny = 50 #50 # 20

my_xpoint = 10.0e1 # 5.0e1 # 3.0e3
my_ypoint = 10.0e1 # 5.0e1 # 1.0e3
my_radius = 9.24e1 # 6.2 miu m

my_wGB = 1.0
my_num_adaptivity = 3
my_Q = 0.85
my_T = 1023 #873.0
my_GBmob0 = 0.7e-9 #5.08e-10
my_GBenergy = 0.0708
# GBMobility = 1.0e-12
