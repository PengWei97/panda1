...
template <bool is_ad>
InputParameters
GBEvolutionGGBaseTempl<is_ad>::validParams()
{
...
template <bool is_ad>
GBEvolutionGGBaseTempl<is_ad>::GBEvolutionGGBaseTempl(const InputParameters & parameters)
...
template class GBEvolutionGGBaseTempl<false>;
template class GBEvolutionGGBaseTempl<true>;
