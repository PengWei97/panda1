...
#include "GGComputeMultiPlasticityStress.h"
...
registerMooseObject("TensorMechanicsApp", GGComputeMultiPlasticityStress);

InputParameters
GGComputeMultiPlasticityStress::validParams()
{
...
GGComputeMultiPlasticityStress::GGComputeMultiPlasticityStress(const InputParameters & parameters)
  : ComputeStressBase(parameters),
    ...
    // _delta_plastic_strain(declareProperty<RankTwoTensor>("delta_plastic_strain")),
...
{
  if (_epp_tol <= 0)
    mooseError("GGComputeMultiPlasticityStress: ep_plastic_tolerance must be positive");
  ...
  if (_n_supplied)
  {
    ...
    if (_n_input.norm() == 0)
      mooseError(
          "GGComputeMultiPlasticityStress: transverse_direction vector must not have zero length");
    else
...
void
GGComputeMultiPlasticityStress::initQpStatefulProperties()
{
  ComputeStressBase::initQpStatefulProperties();

  _plastic_strain[_qp].zero();
  // _delta_plastic_strain[_qp].zero();
  _equivalent_plastic_strain[_qp] = 0;
  // _equivalent_plastic_strain_old[_qp] = 0;
...
void
GGComputeMultiPlasticityStress::computeQpStress()
{
  ...
  auto delta_plastic_strain = _plastic_strain[_qp] - _plastic_strain_old[_qp];
  _equivalent_plastic_strain[_qp] = _equivalent_plastic_strain_old[_qp] + std::sqrt(2.0/3.0*delta_plastic_strain.doubleContraction(delta_plastic_strain));

  _von_mises_stress[_qp] = std::sqrt(3*_stress[_qp].secondInvariant());
}

RankTwoTensor
GGComputeMultiPlasticityStress::rot(const RankTwoTensor & tens)
{
  if (!_n_supplied)
    return tens;
...
void
GGComputeMultiPlasticityStress::preReturnMap()
{
  if (_n_supplied)
  {
...
void
GGComputeMultiPlasticityStress::postReturnMap()
{
  if (_n_supplied)
  {
...
bool
GGComputeMultiPlasticityStress::quickStep(const RankTwoTensor & stress_old,
                                        ...
                                        bool final_step)
{
  ...
  else if (num_plastic_returns == 1 && successful_return)
  {
    ...
    mooseError("GGComputeMultiPlasticityStress::quickStep   should not get here!");
}

bool
GGComputeMultiPlasticityStress::plasticStep(const RankTwoTensor & stress_old,
                                          RankTwoTensor & stress,
                                          const std::vector<Real> & intnl_old,
                                          std::vector<Real> & intnl,
                                          const RankTwoTensor & plastic_strain_old,
...
bool
GGComputeMultiPlasticityStress::returnMap(const RankTwoTensor & stress_old,
                                        RankTwoTensor & stress,
                                        const std::vector<Real> & intnl_old,
                                        std::vector<Real> & intnl,
                                        const RankTwoTensor & plastic_strain_old,
...
bool
GGComputeMultiPlasticityStress::canAddConstraints(const std::vector<bool> & act,
...
bool
GGComputeMultiPlasticityStress::canChangeScheme(DeactivationSchemeEnum current_deactivation_scheme,
                                              bool can_revert_to_dumb)
{
...
void
GGComputeMultiPlasticityStress::changeScheme(const std::vector<bool> & initial_act,
                                           bool can_revert_to_dumb,
...
bool
GGComputeMultiPlasticityStress::singleStep(Real & nr_res2,
                                         RankTwoTensor & stress,
                                         const std::vector<Real> & intnl_old,
                                         std::vector<Real> & intnl,
                                         std::vector<Real> & pm,
...
bool
GGComputeMultiPlasticityStress::reinstateLinearDependentConstraints(
...
unsigned
GGComputeMultiPlasticityStress::numberActive(const std::vector<bool> & active)
{
...
bool
GGComputeMultiPlasticityStress::checkAdmissible(const RankTwoTensor & stress,
...
bool
GGComputeMultiPlasticityStress::checkKuhnTucker(const std::vector<Real> & f,
...
void
GGComputeMultiPlasticityStress::applyKuhnTucker(const std::vector<Real> & f,
                                              const std::vector<Real> & pm,
                                              std::vector<bool> & active)
{
...
Real
GGComputeMultiPlasticityStress::residual2(const std::vector<Real> & pm,
...
bool
GGComputeMultiPlasticityStress::lineSearch(Real & nr_res2,
                                         RankTwoTensor & stress,
                                         const std::vector<Real> & intnl_old,
                                         std::vector<Real> & intnl,
                                         std::vector<Real> & pm,
...
void
GGComputeMultiPlasticityStress::buildDumbOrder(const RankTwoTensor & stress,
                                             const std::vector<Real> & intnl,
                                             std::vector<unsigned int> & dumb_order)
{
...
void
GGComputeMultiPlasticityStress::incrementDumb(int & dumb_iteration,
...
bool
GGComputeMultiPlasticityStress::canIncrementDumb(int dumb_iteration)
{
...
unsigned int
GGComputeMultiPlasticityStress::activeCombinationNumber(const std::vector<bool> & act)
{
  unsigned num = 0;
  for (unsigned surface = 0; surface < _num_surfaces; ++surface)
    if (act[surface])
...
RankFourTensor
GGComputeMultiPlasticityStress::consistentTangentOperator(const RankTwoTensor & stress,
                                                        const std::vector<Real> & intnl,
                                                        const RankFourTensor & E_ijkl,
