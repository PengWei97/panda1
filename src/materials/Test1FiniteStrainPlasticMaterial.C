...
#include "Test1FiniteStrainPlasticMaterial.h"
#include "libmesh/utility.h"

registerMooseObject("TensorMechanicsApp", Test1FiniteStrainPlasticMaterial);

InputParameters
Test1FiniteStrainPlasticMaterial::validParams()
{
...
Test1FiniteStrainPlasticMaterial::Test1FiniteStrainPlasticMaterial(const InputParameters & parameters)
...
void
Test1FiniteStrainPlasticMaterial::initQpStatefulProperties()
{
  ComputeStressBase::initQpStatefulProperties();
  _plastic_strain[_qp].zero();
  _eqv_plastic_strain[_qp] = 0.0;
  _von_mises_stress[_qp] = 0; 
  _hard_factor[_qp] = 2.0e4;
}

void
Test1FiniteStrainPlasticMaterial::computeQpStress()
{
 ...
 */
void
Test1FiniteStrainPlasticMaterial::returnMap(const RankTwoTensor & sig_old,
...
Real
Test1FiniteStrainPlasticMaterial::yieldFunction(const RankTwoTensor & stress, const Real yield_stress)
{
  return getSigEqv(stress) - yield_stress;
}

RankTwoTensor
Test1FiniteStrainPlasticMaterial::dyieldFunction_dstress(const RankTwoTensor & sig)
{
...
Real
Test1FiniteStrainPlasticMaterial::dyieldFunction_dinternal(const Real equivalent_plastic_strain, const Real hf)
{
  return -getdYieldStressdPlasticStrain(equivalent_plastic_strain,hf);
}

RankTwoTensor
Test1FiniteStrainPlasticMaterial::flowPotential(const RankTwoTensor & sig)
{
  return dyieldFunction_dstress(sig); // this plasticity model assumes associative flow
}

Real
Test1FiniteStrainPlasticMaterial::internalPotential()
{
  return -1;
}

Real
Test1FiniteStrainPlasticMaterial::getSigEqv(const RankTwoTensor & stress)
{
...
void
Test1FiniteStrainPlasticMaterial::getJac(const RankTwoTensor & sig,
                                    const RankFourTensor & E_ijkl,
                                    Real flow_incr,
...
Real
Test1FiniteStrainPlasticMaterial::getYieldStress(const Real eqpe, const Real hf)
{
  unsigned nsize;
...
Real
Test1FiniteStrainPlasticMaterial::getdYieldStressdPlasticStrain(const Real eqpe, const Real hf)
{
  unsigned nsize;
