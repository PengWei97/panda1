...
#include "GGComputePolycrystalElasticityTensor.h"
#include "RotationTensor.h"

registerMooseObject("PhaseFieldApp", GGComputePolycrystalElasticityTensor);

InputParameters
GGComputePolycrystalElasticityTensor::validParams()
{
...
GGComputePolycrystalElasticityTensor::GGComputePolycrystalElasticityTensor(
...
void
GGComputePolycrystalElasticityTensor::computeQpElasticityTensor()
{
