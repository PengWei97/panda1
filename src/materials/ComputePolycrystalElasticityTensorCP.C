...
registerMooseObject("pandaApp", ComputePolycrystalElasticityTensorCP);
...
ComputePolycrystalElasticityTensorCP::ComputePolycrystalElasticityTensorCP(
    const InputParameters & parameters)
  : ComputeElasticityTensorBase(parameters),
    _length_scale(getParam<Real>("length_scale")),
    _pressure_scale(getParam<Real>("pressure_scale")),
    _grain_tracker(getUserObject<GrainDataTrackerCP<RankFourTensor>>("grain_tracker")),
