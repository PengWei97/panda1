...
#include "ComputeIncrementalLinearElasticStress.h"

registerMooseObject("TensorMechanicsApp", ComputeIncrementalLinearElasticStress);

InputParameters
ComputeIncrementalLinearElasticStress::validParams()
{
...
ComputeIncrementalLinearElasticStress::ComputeIncrementalLinearElasticStress(const InputParameters & parameters)
...
void
ComputeIncrementalLinearElasticStress::initialSetup()
{
...
void
ComputeIncrementalLinearElasticStress::computeQpStress()
{
  // stress = C * e
