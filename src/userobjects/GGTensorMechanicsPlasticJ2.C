...
#include "GGTensorMechanicsPlasticJ2.h"
#include "RankFourTensor.h"

registerMooseObject("TensorMechanicsApp", GGTensorMechanicsPlasticJ2);

InputParameters
GGTensorMechanicsPlasticJ2::validParams()
{
...
GGTensorMechanicsPlasticJ2::GGTensorMechanicsPlasticJ2(const InputParameters & parameters)
...
Real
GGTensorMechanicsPlasticJ2::yieldFunction(const RankTwoTensor & stress, Real intnl) const
{
  return std::sqrt(3.0 * stress.secondInvariant()) - yieldStrength(intnl);
}

RankTwoTensor
GGTensorMechanicsPlasticJ2::dyieldFunction_dstress(const RankTwoTensor & stress, Real /*intnl*/) const
{
...
Real
GGTensorMechanicsPlasticJ2::dyieldFunction_dintnl(const RankTwoTensor & /*stress*/, Real intnl) const
{
  return -dyieldStrength(intnl);
}

RankTwoTensor
GGTensorMechanicsPlasticJ2::flowPotential(const RankTwoTensor & stress, Real intnl) const
{
  return dyieldFunction_dstress(stress, intnl);
}

RankFourTensor
GGTensorMechanicsPlasticJ2::dflowPotential_dstress(const RankTwoTensor & stress, Real /*intnl*/) const
{
  Real sII = stress.secondInvariant();
  if (sII == 0)
...
RankTwoTensor
GGTensorMechanicsPlasticJ2::dflowPotential_dintnl(const RankTwoTensor & /*stress*/,
                                                Real /*intnl*/) const
{
  return RankTwoTensor();
}
...
Real
GGTensorMechanicsPlasticJ2::yieldStrength(Real intnl) const
{
  return _strength.value(intnl);
}

Real
GGTensorMechanicsPlasticJ2::dyieldStrength(Real intnl) const
{
  return _strength.derivative(intnl);
}

std::string
GGTensorMechanicsPlasticJ2::modelName() const
{
  return "J2";
}

bool
GGTensorMechanicsPlasticJ2::returnMap(const RankTwoTensor & trial_stress,
                                    Real intnl_old,
...
RankFourTensor
GGTensorMechanicsPlasticJ2::consistentTangentOperator(const RankTwoTensor & trial_stress,
                                                    Real intnl_old,
...
bool
GGTensorMechanicsPlasticJ2::useCustomReturnMap() const
{
  return _use_custom_returnMap;
}

bool
GGTensorMechanicsPlasticJ2::useCustomCTO() const
{
