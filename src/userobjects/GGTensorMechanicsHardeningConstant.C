...
#include "GGTensorMechanicsHardeningConstant.h"
#include <math.h> // for M_PI

registerMooseObject("TensorMechanicsApp", GGTensorMechanicsHardeningConstant);

InputParameters
GGTensorMechanicsHardeningConstant::validParams()
{
...
GGTensorMechanicsHardeningConstant::GGTensorMechanicsHardeningConstant(
...
Real GGTensorMechanicsHardeningConstant::value(Real /*intnl*/) const { return _val; }

Real GGTensorMechanicsHardeningConstant::derivative(Real /*intnl*/) const { return 0.0; }

std::string
GGTensorMechanicsHardeningConstant::modelName() const
{
  return "Constant";
}
